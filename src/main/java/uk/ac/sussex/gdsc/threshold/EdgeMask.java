 ...
 * <p>
 * Computes the Laplacian zero crossing points of an image (i.e. where the gradient is steepest). Optionally allows: the
 * edge lines to be pruned to leave only closed loops; and filling of loops to create a mask.
 * <p>
...
public class EdgeMask implements ExtendedPlugInFilter, DialogListener
{
	...
	/**
	 * Use a runnable for the image generation to allow multi-threaded
	 * operation.
	 */
