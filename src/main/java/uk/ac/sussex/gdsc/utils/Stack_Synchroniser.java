 ...
 */
@Deprecated
public class Stack_Synchroniser extends PlugInFrame
    implements ItemListener, ImageListener, ListSelectionListener {
  ...
  private static Panel createChoicePanel(Choice list, String[] options, String selected,
      String label) {
  ...
  public void imageUpdated(ImagePlus imp) {
    if (imp == parentImage && currentSlice != parentImage.getCurrentSlice()
        && !childImages.isEmpty()) {
