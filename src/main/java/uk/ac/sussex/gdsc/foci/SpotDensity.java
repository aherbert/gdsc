 ...
 * loaded from memory. <p> A mask must be defined using a freehand ROI or provided as an image. This
 * is used to create a 2D distance map of foci from the edge of the mask. Any foci within the
 * maximum analysis distance from the edge are excluded from analysis.
 */
