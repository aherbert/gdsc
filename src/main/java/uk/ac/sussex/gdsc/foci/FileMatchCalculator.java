 ...
 * xls files; STORMJ xls files; and a generic CSV file. <p> The generic CSV file has records of the
 * following:<br> ID,T,X,Y,Z,Value<br> Z and Value can be missing. The generic file can also be tab
 * delimited.
 */
