...
public class FindFociOptimisedIntProcessor extends FindFociIntProcessor
{
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.foci.FindFociBaseProcessor#getSortedMaxPoints(java.lang.Object, int[], byte[], float, float)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.foci.FindFociBaseProcessor#assignPointsToMaxima(java.lang.Object, uk.ac.sussex.gdsc.foci.Histogram, byte[],
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.foci.FindFociBaseProcessor#calculateInitialResults(java.lang.Object, int[], java.util.ArrayList)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.foci.FindFociBaseProcessor#calculateNativeResults(java.lang.Object, int[], java.util.ArrayList, int)
	 */
	@Override
