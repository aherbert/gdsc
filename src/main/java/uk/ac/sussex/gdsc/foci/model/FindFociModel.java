...
public class FindFociModel extends AbstractModelObject implements Cloneable {
  ...
  /**
   * @param backgroundMethod the backgroundMethod to set
   */
  ...
  /**
   * @param backgroundParameter the backgroundParameter to set
   */
  ...
  /**
   * @param statisticsMode the statisticsMode to set
   */
  ...
  /**
   * @param minimumAboveSaddle the minimumAboveSaddle to set
   */
  ...
  /**
   * @param connectedAboveSaddle the connectedAboveSaddle to set
   */
  ...
  /**
   * @param peakMethod the peakMethod to set
   */
  ...
  /**
   * @param peakParameter the peakParameter to set
   */
  ...
  /**
   * @param showMask the showMask to set
   */
  ...
  /**
   * @param overlayMask the overlayMask to set
   */
  ...
  /**
   * @param markMaxima the markMaxima to set
   */
  ...
  /**
   * @param markROIMaxima the markROIMaxima to set
   */
  ...
  /**
   * @param markUsingOverlay the markUsingOverlay to set
   */
  ...
  /**
   * @param hideLabels the hideLabels to set
   */
  ...
  /**
   * @param showMaskMaximaAsDots the showMaskMaximaAsDots to set
   */
  ...
  /**
   * @param showLogMessages the showLogMessages to set
   */
  ...
  /**
   * @param removeEdgeMaxima the removeEdgeMaxima to set
   */
  ...
  /**
   * @param resultsDirectory the resultsDirectory to set
   */
  ...
  /**
   * @param gaussianBlur the gaussianBlur to set
   */
  ...
  /**
   * @param centreMethod the centreMethod to set
   */
  ...
  /**
   * @param centreParameter the centreParameter to set
   */
  ...
  /**
   * @param fractionParameter the fractionParameter to set
   */
  ...
  /**
   * @param maskImageList The maskImageList to set
   */
  ...
  /**
   * @param objectAnalysis the objectAnalysis to set
   */
  ...
  /**
   * @param showObjectMask the showObjectMask to set
   */
  ...
  /**
   * @param saveToMemory the saveToMemory to set
   */
  ...
  /**
   * Cause a property changed event to be created with the property name set to "valid". This does
   * not alter any values in the model but serves as a mechanism to raise an event that signals that
   * any calculations based on the model should be refreshed. For example it can be used to signal
   * that a new image has been set without changing the selectedImage property.
   */
