...
public class ColocalisationThreshold_Plugin extends PlugInFrame
  ...
  private static String[] resultsTitles = new String[] {channel1Title, channel2Title,
