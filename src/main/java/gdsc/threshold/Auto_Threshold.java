...
public class Auto_Threshold implements PlugIn
{
	...
	private static String myMethod = "Otsu";
	...
	public void run(String arg)
	{
		...
		String[] methods = { "Try all", "Default", "Huang", "Intermodes", "IsoData", "Li", "MaxEntropy", "Mean",
				"MeanPlusStdDev", "MinError(I)", "Minimum", "Moments", "Otsu", "Percentile", "RenyiEntropy",
			...
			boolean doIset, boolean doIlog, boolean doIstackHistogram)
	{
		...
		threshold = getThreshold(myMethod, data);
	...
	{
		Auto_Threshold.stdDevMultiplier = stdDevMultiplier;
	}
	...
	public static int RenyiEntropy(int[] data)
	{
		...
		opt_threshold = (int) (t_star1 * (P1[t_star1] + 0.25 * omega * beta1) + 0.25 * t_star2 * omega * beta2 + t_star3 *
	...
	public static int getThreshold(String myMethod, int[] data)
	{
		...
		else if (myMethod.equals("MeanPlusStdDev"))
		{
			threshold = MeanPlusStdDev(data2);
		}
